      ...
      <NavigationContainer>
        ...
        >
          ...
          <Drawer.Screen
            ...
            options={{
              drawerIcon: ({color}) => (
                <Ionicons name="fast-food-outline" size={20} color={color} /> // Icon for the new screen
              ),
              drawerLabelStyle:{
                fontSize: 18
              }
          ...
          />
            ...
            options={{
              drawerIcon: ({color}) => (
                <Ionicons name="book-outline" size={20} color={color} /> // Icon for the new screen
              ),
              drawerLabelStyle:{
                fontSize: 18
              }
          ...
          <Drawer.Screen 
            ...
            options={{
              drawerIcon: ({color}) => (
                <Ionicons name="arrow-up-circle-outline" size={20} color={color} /> // Icon for the new screen
              ),
              drawerLabelStyle:{
                fontSize: 18
              }
